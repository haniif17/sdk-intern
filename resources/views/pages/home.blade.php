...
<section class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="w-full bg-[#F4F1E8] rounded-3xl px-8 py-10">

        {{-- TITLE --}}
        <h2 class="text-3xl md:text-4xl font-semibold mb-8 text-left text-gray-800">
            Keunggulan
        </h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {{-- ITEM 1 (Tengah Kota) --}}
            <div class="border-2 border-black/20 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:border-black transition duration-300 flex flex-col justify-start bg-white/50 hover:bg-white group">
                
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 mb-4 text-red-600 group-hover:scale-110 transition duration-300">
                ...
                <p class="text-sm text-gray-600 mt-2 leading-relaxed">
                    Lokasi strategis di pusat Kota Semarang (Tri Lomba Juang), sangat mudah diakses dari berbagai arah.
                </p>
            </div>

            {{-- ITEM 2 (Fasilitas Gratis) --}}
            <div class="border-2 border-black/20 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:border-black transition duration-300 flex flex-col justify-start bg-white/50 hover:bg-white group">
                ...
                <p class="text-sm text-gray-600 mt-2 leading-relaxed">
                    Nikmati ruang kerja, proyektor, dan berbagai fasilitas pendukung lainnya tanpa dipungut biaya.
                </p>
            </div>

            {{-- ITEM 3 (Wadah Komunitas) --}}
            <div class="border-2 border-black/20 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:border-black transition duration-300 flex flex-col justify-start bg-white/50 hover:bg-white group">
                ...
                <p class="text-sm text-gray-600 mt-2 leading-relaxed">
                    Ruang kolaborasi ideal untuk menghubungkan berbagai komunitas kreatif, *startup*, dan pegiat IT.
                </p>
            </div>

            {{-- ITEM 4 (Internet Cepat) --}}
            <div class="border-2 border-black/20 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:border-black transition duration-300 flex flex-col justify-start bg-white/50 hover:bg-white group">
                ...
                <p class="text-sm text-gray-600 mt-2 leading-relaxed">
                    Koneksi Wi-Fi berkecepatan tinggi dan stabil untuk menjamin kelancaran aktivitas digital Anda.
                </p>
            </div>
